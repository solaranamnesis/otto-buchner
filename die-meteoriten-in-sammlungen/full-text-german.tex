...
\begin{itemize}
    ...
    \item Gießen, Universit"at (durch Herrn Professor Knop). Fallorte 6.
    ...
    \item Gießen, Realschule (Dr. Buchner). Fallorte 2.
...
\begin{itemize}
    ...
    \item Dr. Lawr. Smith, Professor in Louisville (durch g"utige Mitteilung der Herren Haidinger in Wien und Shepard in New-Haven), etwa Fallorte 50. und an großen Massen Fallorte 10. Ist j"ungst wohl großenteils in die Berliner Sammlung "ubergegangen.
    ...
    \item Dr. Troost in Nashville, jetzt bei Maj. Troost in Mobile, Alabama (nach Mitteilung des Herrn Shepard). Fallorte 9. in sehr großen Exemplaren, außerdem wohl Fallorte 20. in Bruchst"ucken.
    ...
    \item Dr. Buchner in Gießen. Fallorte 18.
    ...
    \item Dr. Phoebus, Professor in Gießen. Fallorte 10.
...
(Dezember 15, 1862. Von P. Partsch,\footnote{Partsch Die Meteoriten im k. k. Hof-Mineralien-Kabinette zu Wien 1843. Es sind gleichzeitig die gr"oßeren "offentlichen Sammlungen aufgef"uhrt, wo noch Steine und Bruchst"ucke aufbewahrt sind, sowie die Seitenzahl, wo die betreffende Monographie zu finden ist.} fortgesetzt von Dr. M. H"ornes.)
\end{center}
\begin{center}
1. Meteorsteine.
\end{center}
\begin{itemize}
    ...
    \item[b.] Mit metallischem Eisen; die Rinde matt (die Steine folgen hier in Gruppen aufeinander, so dass die metall"armsten beginnen und die metallreichsten schließen. Jede Gruppe enth"alt die ihrem Aussehen nach verwandtesten Steine).
    ...
    \item Siena. 1794, Juni 46 (Berlin, G"ottingen, London, Clausthal).
    ...
    \item Segowlee. 1853, M"arz 6 (Calcutta). 85.

    \item Duruma. 1853, (M"unchen). 85.

    \item Nulles. 1851, Nov. 5 (Madrid, Barcelona, London). 81.

    \item Renazzo. 1824, Jan. 13 (Bologna, Stockholm, Paris, Pisa, Berlin). 46.

    \item Richmond. 1828, Juni 4 (London, Berlin, G"ottingen, Paris). 52.

    \item Weston. 1807, Dez. 14 (London, Stockholm, Paris, Berlin, G"ottingen). 22.

    \item Epinal. 1822, Sept. 13 (Paris, Berlin). 44.

    \item Little Piney. 1839, Febr. 13 (London, Berlin). 63.

    \item Aussun. 1858, Dez. 9 (Paris, Berlin, London, G"ottingen u. A.). 99.

    \item Benares. 1798, Dez. 13 (London, Edinburgh, Paris, Berlin, G"ottingen). 14.

    \item Quenggouk. 1857, Dez. 27 (Calcutta, London). 97.

    \item Trenzano. 1856, Nov. 12 (London). 90.

    \item Utrecht. 1843, Juni 2 (Harlem, Utrecht, G"ottingen). 71.

    \item Gouv. Poltava. ? (Petersburg, Berlin). 114.

    \item Borkút. 1852, Okt. 13. 83.

    \item Krasnoy-Ugol. 1829, Sept. 9 (Petersburg, Berlin). 53.

    \item Erxleben. 1812, Apr. 15 (G"ottingen, Berlin, London u. A.). 30.

    \item Kleinwenden. 1843, Sept. 16 (Berlin). 73.

    \item Gouv. Simbirsk. ? (Petersburg). 115.

    \item Iowa. 1847, Febr. 25 (Edinburgh, Berlin, London, G"ottingen). 76.

    \item Mauerkirchen. 1768, Nov. 20 (M"unchen, London, Berlin u. A.). 8.

    \item Monte Milone. 1846, Mai 8 (Bologna, Pisa, Florenz). 75.

    \item Nashville. 1827, Mai 9 (Leiden, Berlin, London, G"ottingen). 50.

    \item Kakowa. 1858, Mai 19 (G"ottingen, Berlin). 98.

    \item Lucé. 1768, Sept. 13 (Berlin, Z"urich, Freiberg). 7.

    \item Lissa. 1808, Sept. 3 (Berlin, London, Paris, Prag, G"ottingen u. A.). 26.

    \item Oahu. 1825, Sept. 27 (Dorpat, Berlin, London). 49.

    \item Oesel. 1855, Mai 11 (Dorpat, Berlin, G"ottingen, London). 87.

    \item Nellore. 1852, Jan. 23 (Madras). 82.

    \item Charkow. 1787, Okt. 13 (Charkow, Petersburg, London, G"ottingen, Berlin). 10.

    \item Schie. 1848, Dez. 27 (Christiania, London). 78.

    \item Zaborzika. 1818, Apr. 10 (Kiew, Berlin, London). 37.

    \item Futtehpore. 1822, Nov. 30 (Calcutta, London). 44.

    \item Bachmut. 1814, Febr. 3 (Charkow, London, Berlin, Petersburg). 34.

    \item Aumières. 1842, Juni 4 (Paris). 68.

    \item Pohlitz. 1819, Okt. 13 (Gera, Berlin, London, G"ottingen u. A.). 40.

    \item Kuleschowka 1811, M"arz 12/13 (Petersburg, London, Berlin). 28.

    \item Girgenti. 1853, Febr. 10 (London). 84.

    \item Slobodka. 1818, Aug. 10 (Petersburg, Berlin, Paris). 39.

    \item Kikina. 1809. 21.

    \item Milena. 1842, Apr. 26 (Agram, Gr"atz, Berlin). 67.

    \item Forsyth. 1829, Mai 8 (London, Berlin, Dublin). 53.

    \item Wold Cottage. 1795, Dez. 13 (London, G"ottingen, Paris, Berlin). 12.

    \item High-Possil. 1804, Apr. 5 (London). 18.

    \item Berlanguillas. 1811, Juli 8 (Paris, Berlin, London, G"ottingen). 29.

    \item Apt. 1803, Okt. 8 (Paris, Berlin, Gotha). 17.

    \item Vouillé. 1831, Juli 18 (Paris, Berlin). 54.

    \item Château Renard. 1841, Juni 12 (London, Paris, Berlin, G"ottingen). 66.

    \item Ohaba. 1857, Okt. 11 (G"ottingen). 96.

    \item Salés. 1798, M"arz 8? 12? (London, Paris, Berlin, G"ottingen). 13.

    \item Agen. 1814, Sept. 5 (Paris, London, G"ottingen, Berlin). 35.

    \item Garz. 1715, Apr. 11 (Berlin, London). 5.

    \item Nanjemoy. 1825, Febr. 10 (London, Berlin, G"ottingen, Dublin). 48.

    \item New Concord. 1860, Mai 1 (London, Berlin, G"ottingen, Z"urich). 104.

    \item S. Denis Westrem. 1855, Juni 7 (G"ottingen). 89.

    \item Killeter. 1844, Apr. 29 (London, Dublin). 74.

    \item Asco. 1805, Nov. (Berlin). 19.

    \item Toulouse. 1812, Apr. 10 (Paris, Berlin, London, Stockholm). 30.

    \item Blansko. 1833, Nov. 25 (Berlin, Stockholm). 56.

    \item Cereseto. 1840, Juli 17 (Turin, London, Paris, Bologna). 65.

    \item Heredia. 1857, Apr. 1 (G"ottingen). 93.

    \item Wessely. 1831, Sept. 9 (Br"unn, Berlin). 55.

    \item Limerick. 1813, Sept. 10 (Paris, G"ottingen, Berlin). 33.

    \item Gr"uneberg. 1841, M"arz 22 (Berlin, Breslau, T"ubingen, London). 65.

    \item Tipperary. 1810, Aug. (Dublin, London, Berlin, Kopenhagen). 27.

    \item Gouv. Kursk. ? (Petersburg). 114.

    \item Lixna. 1820, Juli 12 (G"ottingen, Berlin, Dorpat, Paris, London). 41.

    \item Cabarras County. 1849, Okt. 31 (London, Berlin, G"ottingen). 79.

    \item Tabor. 1753, Juli 3 (London, Berlin, Prag, Pesth). 6.

    \item Charsonville. 1810, Nov. 23 (Paris, Berlin, Bern, Uppsala). 28.

    \item Esnandes. 1837, Aug. (Bordeaux). 60.

    \item Doroninsk. 1805, Apr. 10 (Berlin). 18.

    \item Mez"o-Madaras. 1852, Sept. 4 (Berlin, London, Kopenhagen, G"ottingen). 82.

    \item Assam. 1846. (Calcutta, London). 115.

    \item Bremerv"orde. 1855, Mai 13 (G"ottingen, Clausthal, Stockholm, Berlin). 88.

    \item Parnallee. 1857, Febr. 28 (London, Berlin, G"ottingen). 94.

    \item Dhurmsala. 1860, Juli 14 (Calcutta, London, Berlin, Boston). 106.

    \item Mhow. 1827, Febr. 16 (Calcutta, London). 50.

    \item Seres. 1818, Juni (G"ottingen, Berlin, London). 38.

    \item Sigena. 1773, Nov. 17 (Paris). 9.

    \item Kheragur. 1860, M"arz 28 (Calcutta, London). 104.

    \item Barbotan. 1790, Juli 24 (London, Paris, Bordeaux, Berlin u. A). 11.

    \item Charvallas. 1834, Juni 12 (London). 57.

    \item Eichst"adt. 1785, Febr. 19 (M"unchen, Berlin, G"ottingen, London). 9.

    \item Gro"s-Divina. 1837, Juli 24 (Pesth). 59.

    \item Zebrak. 1824, Okt. 14 (Prag, London). 47.

    \item G"utersloh. 1851, Apr. 17 (Berlin, London). 80.

    \item Darmstadt. ? (Heidelberg, London). 113.

    \item Timochin. 1807, M"arz 13 (Petersburg, Berlin, London, G"ottingen). 21.

    \item Macao. 1836, Nov. 11 (Berlin, G"ottingen, Paris, Petersburg). 58.

    \item Hainholz. ? (London, Berlin, G"ottingen). 130.

    \item II\. Meteoreisen.

    \item[A.] "Astig (mit Olivin in den H"ohlungen).

    \item Atacama. (London, Paris, G"ottingen, Berlin u. A). 127.

    \item Krasnojarsk. (fast in allen Sammlungen). 121.

    \item Oregon. 131.

    \item Brahin. (Kiew, Berlin, London, Wien, u. A.). 129.

    \item Sachsen (Steinbach, Rittersgr"un). (London, Freiberg, Berlin u. A). 124.

    \item[B.] Derbes Meteoreisen (Einmengungen nur in geringer Menge und nicht von gestaltendem Einfluss auf das Eisen).

    \item Bitburg. (Berlin, Trier, New-Haven). 126.

    \item Toluca. (G"ottingen, Darmstadt, London, Berlin u. A.). 139.

    \item Elbogen. (Prag, Uppsala, Berlin u. A.). 151.

    \item Putnam County. (London, G"ottingen, Berlin, Paris). 162.

    \item Oldham County. (London). 197.

    \item L"owenfluss. (London, Berlin). 186.

    \item Agram (1754, Mai 26) (London, Berlin, G"ottingen u. A.). 135.

    \item Lockport. (London, Edinburgh, Dublin). 173.

    \item Tazewell. (London, Berlin, Hudson). 187.

    \item Robertson County. (London). 197.

    \item Lenartó. (Pesth, London, Paris, Berlin u. A). 152.

    \item Petropawlowsk. (Petersburg). 163.

    \item Schwetz. (Berlin, London, G"ottingen). 182.

    \item Madoc. (London, Paris). 191.

    \item Nebraska. (London, G"ottingen). 196.

    \item Marshall County. (London, Hudson). 194.

    \item Denton County. (Austin, G"ottingen). 192.

    \item Red River. (New-Haven, London, Berlin u. A). 153.

    \item Seneca River. (G"ottingen, London, Berlin). 186.

    \item Oaxaca. (Berlin). 148.

    \item Oranje River. (London, G"ottingen, Berlin). 193.

    \item Rutherford. (London). 181.

    \item Durango. (Berlin, London, Paris u. A). 149.

    \item Smith County. (London, Berlin, G"ottingen u. A.). 174.

    \item Ruffs Mountains. (London, Berlin, Kopenhagen u. A.). 184.

    \item Jewell Hill. (London, Hudson). 194.

    \item Guilford County. (New-Haven, London, G"ottingen). 167.

    \item La Caille. (Paris, Stockholm, Berlin). 158.

    \item Burlington. (London, Berlin, G"ottingen, Kopenhagen u. A.). 170.

    \item Tula. (London, Berlin). 195.

    \item Asheville. (London, Berlin, G"ottingen u. A.). 163.

    \item Cocke County. (Berlin, London, G"ottingen u. A). 164.

    \item Arva. (London, Berlin, G"ottingen, Uppsala u. A). 168.

    \item Tabarz. (G"ottingen). 189.

    \item Sarepta. (Berlin, W"urzburg, Stuttgart u. A). 190.

    \item Bohumilitz. (Prag, Berlin, G"ottingen u. A). 158.

    \item Seel"asgen. (London, Berlin u. A.). 178.

    \item Cranbourne. (London, Kopenhagen). 198.

    \item Black Mountains. (London, Kopenhagen, G"ottingen). 180.

    \item Brazos. (Austin). 161.

    \item Union County. (London). 187.

    \item Nelson County. (Berlin, London). 198.

    \item Bahia. (M"unchen, London, G"ottingen, u. A.). 142.

    \item Pittsburg. (G"ottingen). 185.

    \item Braunau (1847, Juli 14) (Berlin, Breslau, London u. A.). 176.

    \item Tuczon. (London). 183.

    \item Concepcion. 138.

    \item Saltillo. (Washington). 192.

    \item Zacatecas. (London, Berlin, Heidelberg, M"unchen u. A.). 144.

    \item Rasgatà. (Paris, Berlin, London, Petersburg, G"ottingen). 155.

    \item Scriba. (London, G"ottingen). 166.

    \item Tucuman. (London, Kopenhagen, Berlin, Paris, G"ottingen). 136.

    \item Salt River. (London, Berlin). 185.

    \item Senegal. (Paris, Berlin, London, G"ottingen). 136.

    \item Chesterville. (London, Berlin, G"ottingen). 182.

    \item Kap der guten Hoffn. (London, G"ottingen, Heidelberg). 146.

    \item Green County. (London, G"ottingen, Edinburgh, Berlin). 172.

    \item Livingston County. (London). 174.

    \item Claiborne. (London, Berlin). 161.

    \item Morgan County. 181.

    \item Gr"onland. (Kopenhagen u. A.). 154.

    \item Madagascar. 174.

    \item Hemalga. (London, Edinburgh, Paris). 190.
\end{itemize}
...
3\. Ordnung. Bimssteinartig (Waterville).\footnote{Nicht meteorisch.}
